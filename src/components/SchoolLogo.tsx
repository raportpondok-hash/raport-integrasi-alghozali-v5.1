...
/**
 * Official School Logo of YPI AL-GHOZALI (Pondok Modern Al-Ghozali).
 * 100% transparent background vector SVG.
 * Zero white rectangular borders/boxes, zero distortion, and crisp print fidelity.
 */
export const SchoolLogo: React.FC<SchoolLogoProps> = ({ 
  className = '', 
  size = 85,
  idPrefix = 'school-logo' 
}) => {
  return (
    <svg
      width={size}
      height={Math.round(size * 1.025)}
      viewBox="0 0 200 205"
      fill="none"
      ...
      style={{
        width: `${size}px`,
        height: `${Math.round(size * 1.025)}px`,
        maxWidth: '100%',
    ...
    >
      ...
      <circle cx="100" cy="114" r="5" fill="#ffd700" stroke="#0f592f" strokeWidth="1" />
      ...
      <g>
        <rect x="92" y="137" width="16" height="7.5" rx="3.75" fill="#ffd700" stroke="#0f592f" strokeWidth="1" />
        <circle cx="95" cy="140.75" r="3.2" fill="#ffd700" stroke="#0f592f" strokeWidth="0.8" />
        <circle cx="105" cy="140.75" r="3.2" fill="#ffd700" stroke="#0f592f" strokeWidth="0.8" />
      ...
      <g>
        <rect x="90" y="157" width="5.5" height="9" rx="2.5" fill="#ffd700" stroke="#0f592f" strokeWidth="0.9" />
        <rect x="91.5" y="159" width="2.5" height="5" rx="1.2" fill="#d5f0a8" />

        <rect x="97" y="157" width="6" height="9" rx="2.5" fill="#ffd700" stroke="#0f592f" strokeWidth="0.9" />
        <rect x="98.5" y="159" width="3" height="5" rx="1.2" fill="#d5f0a8" />

        <rect x="104.5" y="157" width="5.5" height="9" rx="2.5" fill="#ffd700" stroke="#0f592f" strokeWidth="0.9" />
